<template>
  <div class="biggest_content">
        ...
        <div class="right rightC">
          ...
          <el-collapse v-model="activeNames2" class="rightC1">
            ...
            <el-collapse-item title="用户评级" name="2">
              ...
              <div class="qrcode" id="qrcode2" ref="qrcode" style="width:35%;height:30%;">
                <img alt="Scan me!" style="display: block;" id="qrcodeImg" :src="qrcodeimg" />
              </div>
            </el-collapse-item>
          </el-collapse>
          ...
          <el-collapse v-model="activeNames" class="leftC">
            <el-collapse-item title="产品信息" name="1" class="leftC1">
              <el-tabs type="card" v-model="currentName2" @tab-click="handleClick">
                <el-tab-pane label="养殖场" name="first"></el-tab-pane>
                <el-tab-pane label="屠宰加工厂" name="second">
                  <div class="factory">
                    ...
                    <div
                      style="width: 48%; float:right; white-space: nowrap; overflow: hidden;text-overflow: ellipsis;"
                    >
            ...
            <el-collapse-item title="产品图像" name="3" class="leftC2">
              ...
              <el-carousel height="150px">
                <el-carousel-item v-for="item in slaPictures" :key="item">
                  <div style="margin: 0 auto;" @click="watchBigPic(item,'产品图像')">
                    <img :src="item" alt />
                  </div>
                </el-carousel-item>
              </el-carousel>
        ...
        <div class="right rightC">
          ...
          <el-collapse v-model="activeNames2" class="rightC1">
            ...
            <el-collapse-item title="用户评级" name="1">
              ...
              <div class="qrcode" ref="qrcode" style="width:35%;height:30%;">
                <img alt="Scan me!" style="display: block;" id="qrcodeImg" :src="qrcodeimg" />
              </div>
            </el-collapse-item>
          </el-collapse>
        ...
        <div class="left">
          <el-collapse v-model="activeNames" class="leftC">
            ...
            <el-collapse-item title="产品图像" name="3" class="leftC2">
              ...
              <el-carousel height="150px">
                <el-carousel-item v-for="item in ConsumerSheepPics" :key="item">
                  <div style="margin: 0 auto;" @click="watchBigPic(item,'产品图像')">
                    <img :src="item" alt />
                  </div>
                </el-carousel-item>
    ...
    >
      ...
      <record-table type="table" title="检疫" :data="checkData"></record-table>
    </el-dialog>
    ...
    >
      ...
      <record-table type="table" title="宰前" :data="befslaData"></record-table>
    </el-dialog>
    ...
    >
      ...
      <record-table type="table" title="屠宰" :data="slaData"></record-table>
    </el-dialog>
    ...
    >
      ...
      <record-table type="table" title="运输" :data="endData"></record-table>
    </el-dialog>
    ...
    <el-dialog title="视频" :visible.sync="mediaVisible" width="40%">
      <div class="show-detail">
        <video
          :src="mediaUrl"
  ...
  created() {
    ...
    getSheepInfo(this.code).then(re => {
      ...
      if (data != null) {
        ...
        info.arriveTime =
          data.model.createTime && data.model.createTime.slice(0, 10);
    ...
    getConsumerInfoByearTag(this.code).then(re => {
      ...
      if (data != null) {
        ...
        console.log("long", info.longitude);
        console.log("latitude", info.latitude);
        this.consumerFactoryPics =
          re.data.factoryVideo && re.data.factoryVideo.pic_address;
        console.log(re.data.sheepVideo);
