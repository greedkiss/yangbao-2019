<template>
  <div class="admin-form">
    ...
    >
      ...
      <el-table-column label="屠宰前时间" width="160" prop="time"></el-table-column>
    ...
    <el-dialog title="图片详情" :visible.sync="dialogFormVisible" width="650px">
      <div>
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      window
        .fetch(baseUrl + "/slaughter/appendage", {
          method: "POST",
          headers,
          body: form
        })
