            ...
            <div class="border-main" >
                ...
                <div class="formAndCarmera">
                    <div class="formWraaper">
                        ...
                        <div class="inputWrapper">
                            <span class="inputSpan ellipse" @click="getWeight" style="width:65%">点击获取附属物重量</span>
                            <el-input  size="small" style="width:35% !important" v-model="appendageWeight"></el-input>
                        </div>
                        <div class="inputWrapper">
