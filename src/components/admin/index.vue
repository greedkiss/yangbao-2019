        ...
        return {
            ...
            productionTree: {
                ...
                children: [
                    ...
                    {label: '智能管理', to: 'intelManage', children: [
                        {label: '引种阶段', to: 'introduction'},
                        {label: '空怀阶段', to: 'nonpregnant'},
                        {label: '配种阶段', to: 'breedStage',
                            children:[{label: '引种阶段1', to: 'introduction1'}]},
                        {label: '妊娠阶段', to: 'pregnantStage'},
                        {label: '产羔阶段', to: 'produceStage'},
                        {label: '断奶阶段', to: 'weanedStage'}, 
                    ]},
