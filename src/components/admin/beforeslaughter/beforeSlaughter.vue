  ...
  <div class="admin-form">
          ...
          <div style="margin-top:25px">
            <div class="inputWrapper">
              <el-button
                ...
                size="small"
                @click="getWeight"
                style="width:35%; border-radius:15px"
              >点击获取重量</el-button>
              <el-input
                size="small"
    ...
    <div>
      <el-table :data="tableData" style="width: 100%">
        <el-table-column label="商标耳牌号" width="120">
        ...
        <el-table-column label="重量" width="120" prop="weight"></el-table-column>
        <el-table-column label="时间" width="160" prop="time"></el-table-column>
        <el-table-column label="来源养殖场" width="250" prop="breedFactory"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    async printCode(start) {
      ...
      let src = document
        .getElementById("qrcode1")
        .children[1].getAttribute("src");
      let docStr = `<div style="page-break-after:always; width:100px"><canvas height="300" style="display: none;"></canvas><div style="margin-top:-5px; text-align:center"><img alt="Scan me!" src="${src}"style="display: block;" width="95"><p style="font-size:10px; transform:scale(0.6,0.6);margin-top:-5px">${this.codeNumber}</p></div>`;
    ...
    chooseID(index) {
      ...
      this.$nextTick(() => {
        this.$set(
          this,
          "tradeMarkEarTag",
          this.tableData[index].trademarkEarTag
        );
        this.$nextTick(() => {
