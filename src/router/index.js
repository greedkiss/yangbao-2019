...
// 智能管理
const Introduction = () => import('@/components/admin/intelManage/introduction')
const Situation = () => import('@/components/admin/intelManage/situation')
// 营养生产
...
export default new Router({
    routes: [
        ...
        {path: '/admin/:id', component: Admin, meta: {requireAuth: true}, children: [
            ...
            {path: 'intelManage/intr', name: 'introduction', component: Introduction},
            {path: 'intelManage/nonp', name: 'nonpregnant', component: LivestockList},
            {path: 'intelManage/breed', name: 'breedStage', component: LivestockSale},
            {path: 'intelManage/preg', name: 'pregnantStage', component: LivestockDead},
            {path: 'intelManage/prod', name: 'produceStage', component: LivestockAdd},
            {path: 'intelManage/wean', name: 'weanedStage', component: LivestockBuy},
            {path: 'intelManage/case', name: 'situation', component: Situation},
            // 卫生疫控
